...
@section('content')
    <main class="main" id="rooms-item">
        <article class="main__article article">
            <div class="article__header-wr">
                    ...
                    <div class="article__description wow fadeInLeft">
                        ...
                        <div class="article__sign wow fadeInLeft">
                            ...
                            <p class="article__information">
                                Тепсей — величественная двуглавая гора высотой 639 метров, расположенная на правом берегу Енисея, в
                                устье
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide d-flex flex-column align-items-center">
                            <div class="article__slider-img-wr">
                                <img src="{{ asset('front/img/item-slider-img.jpg') }}" alt="">
                            </div>
                            <p class="article__slider-description exo">
                                На фото виды с вершины Тепсея
                            </p>
                            <p class="article__slider-author">
                                Автор фото - Вадим Беловолов
                            </p>
                        </div>
                        <div class="swiper-slide d-flex flex-column align-items-center">
                            <div class="article__slider-img-wr">
            ...
            <section class="article__feedback article__block">
                ...
                <div class="article__feedback-slider d-flex j wow fadeInUp">
                    <div class="feedback">
            ...
            <section class="article__events article__block">
                ...
                <div class="article__events-slider wow fadeInUp">
                    <div class="swiper-container article__events-slider-cont">
                        <div class="swiper-wrapper">
                    ...
                    <script>
                        const swiper = new Swiper('.article__events-slider-cont', {
                            slidesPerView: 'auto',
                            spaceBetween: 79,
            ...
            <section class="article__place-for-sleep article__block">
                ...
                <div class="article__place-slider wow fadeInUp">
                    <div class="swiper-container article__events-slider-cont">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="list__item d-flex flex-column">
                    ...
                    <script>
                        const swiper2 = new Swiper('.article__events-slider-cont', {
                            slidesPerView: 'auto',
                            spaceBetween: 79,
                            slidesOffsetBefore: 170,
