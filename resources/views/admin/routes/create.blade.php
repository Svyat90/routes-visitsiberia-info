            ...
            <form method="POST" action="{{ route("admin.routes.store") }}">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                        <label class="required" for="{{ $name = 'active' }}">{{ __("cruds.routes.fields.$name") }}</label>
                    ...
                    <div class="form-group col-md-6 col-sm-6 col-xs-6">
                        <label class="required" for="{{ $name = 'recommended' }}">{{ __("cruds.routes.fields.$name") }}</label>
                        <select name="{{ $name }}" id="{{ $name }}" class="form-control">
                            <option value="0" {{ old($name, null) == "0" ? 'selected' : '' }}>{{ __('global.no') }}</option>
                            <option value="1" {{ old($name, null) == "1" ? 'selected' : '' }}>{{ __('global.yes') }}</option>
                        </select>
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                        <label class="required" for="{{ $name = 'image' }}">{{ __("cruds.routes.fields.$name") }}</label>
