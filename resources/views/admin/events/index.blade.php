...
@section('content')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route("admin.events.create") }}">
                {{ __('global.add') }} {{ __('cruds.events.title_singular') }}
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            {{ __('cruds.events.title_singular') }} {{ __('global.list') }}
        </div>
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-events">
                ...
                <tr>
                    ...
                    <th>
                        {{ __('cruds.events.fields.name') }} ({{ app()->getLocale() }})
                    </th>
                    <th>
                        {{ __('cruds.events.fields.slug') }}
                    </th>
                    <th>
                        {{ __('cruds.events.fields.active') }}
                    </th>
                    <th>
                        {{ __('cruds.events.fields.have_camping') }}
                    </th>
                    <th>
    ...
    <script>
        $(function () {
            ...
            let deleteButton = {
                ...
                url: "{{ route('admin.events.multi_destroy') }}",
            ...
            let dtOverrideGlobals = {
                ...
                columns: [
                    ...
                    {data: 'have_camping', name: 'have_camping'},
